"use strict";
// Sets the javascript to use strict mode.
/*
...
*/
// Sets the date to the current date and stores it in the thisDate variable.
var thisDate = new Date();
// The dateString variable contains the date but in local string form.
var dateString = thisDate.toLocaleString();
// dateHtml stores the date string bug in an html format.
var dateHtml = "<h2>" + dateString + "</h2>";
// The thisDay varaible stores the current day in number form.
var thisDay = thisDate.getDay();
// Stores the result of the getEvent() function.
var eventHTML = getEvent(thisDay);

// Sets the element with the id of unionToday to have the dateHtml and EventHTML in it. It is inserted before the ending of the element.
document.getElementById("unionToday").insertAdjacentHTML('beforeend', dateHtml + eventHTML);

// The following code came with the file.
